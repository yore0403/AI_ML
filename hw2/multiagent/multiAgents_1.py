...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        evaluateScoresWeight = [10.0, 100.0,80.0, 100.0,100000.0]#for evaulate weight
        #[food,ghost,capsule,ghostcapsule,ghosteaten]
        expDecayFactors = [0.25, 0.75, 0.6,0,0.7]
        #[food,ghost,capsule]  
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def alphabeta(self, state, depth, agent, alpha = -100000000, beta = 100000000):
        ...
        v = 100000000
        scores = [self.alphabeta(state.generateSuccessor(agent, action), depth - 1, (agent + 1)%state.getNumAgents(),alpha, beta)[0] for action in actions]
    ...
    def getAction(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.alphabeta(gameState, self.depth * 2, 0)[1]
        util.raiseNotDefined()
...
def betterEvaluationFunction(currentGameState):
    ...
    #[food,ghost,capsule,ghostcapsule,ghosteaten]
    expDecayFactors = [0.25, 0.75, 0.6,0,0.6]
    #[food,ghost,capsule]  
    ...
    # same numfood see nearst food distance  
    foodScore -= mindistance*evaluateScoresWeight[FOOD]*0.01
